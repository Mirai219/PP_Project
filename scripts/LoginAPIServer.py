...
import json
from GithubOAuthClient import GithubOAuthClient
from scripts.GithubUserInfoClient import GithubUserInfoClient
import os
import pathlib
...
log_path = os.path.join(project_root, 'logs', 'login_api_server.log')
    ...
    def do_POST(self):
        ...
        if path == '/api/v1/login/github':
            ...
            try:
                ...
                # 获取 access_token
                github_oauth_client_instance = GithubOAuthClient(GITHUB_CLIENT_ID, GITHUB_CLIENT_SECRET, GITHUB_REDIRECT_URI, code)
                ...
                # 获取用户信息
                github_user_api_client_instance = GithubUserInfoClient(access_token)       
